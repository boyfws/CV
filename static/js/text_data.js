const textData = {
    "ru": {
        ...
        "about-me-text": "Я хочу получить опыт работы с ML в самых разных областях, например поучаствовать в разработке рекомендательных систем или позаниматься использованием машинного обучения для прогнозирования временных рядов",
        "hse-name": "НИУ «ВШЭ»",
    ...
    "en": {
        ...
        "about-me-text": "I want to gain experience with ML in a variety of areas, such as getting involved in developing recommender systems or using machine learning for time series forecasting",
        "hse-name": "HSE",
